<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li> <a class="waves-effect waves-dark" href="{{ route('home') }}" aria-expanded="false"><i class="fa fa-tachometer-alt"></i><span class="hide-menu">@lang('custom.dashboard')</span></a>
                </li>
                ...
                <li> <a class="waves-effect waves-dark logout" href="{{ route('logout') }}" aria-expanded="false"><i class="fa fa-sign-out-alt"></i><span class="hide-menu">@lang('custom.logout')</span></a>
                </li>
                {!! Form::open([
                    'id' => 'logout-form', 
                    'method' => 'POST', 
